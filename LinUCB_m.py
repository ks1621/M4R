...
### This is not used, but included so there is no import error and code does not break

def LinUCB_m(self, la=0.5, delta=0.05/2, noise=0.5, T=1000, steps=100, p=0.25, fixed=[False, -1]):
